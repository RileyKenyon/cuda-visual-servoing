...
if(PKG_CONFIG_FOUND)
    ...
    if(NOT LIBAVDEVICE_LIBRARY)
        pkg_check_modules(_LIBAV_AVDEVICE libavdevice)
    endif()
    if(NOT LIBAVFILTER_LIBRARY)
        pkg_check_modules(_LIBAV_AVFILTER libavfilter)
    endif()
    if(NOT LIBSWRESAMPLE_LIBRARY)
        pkg_check_modules(_LIBAV_SWRESAMPLE libswresample)
    endif()
...
find_path(LIBAVDEVICE_INCLUDE_DIR
    ...
    PATHS ${_LIBAV_AVDEVICE_INCLUDE_DIRS}
...
find_path(LIBAVFILTER_INCLUDE_DIR
    ...
    PATHS ${_LIBAV_AVFILTER_INCLUDE_DIRS}
        /usr/include /usr/local/include
        /opt/local/include /sw/include
    PATH_SUFFIXES libav ffmpeg
)
find_path(LIBAVFORMAT_INCLUDE_DIR
    ...
    PATHS ${_LIBAV_AVFORMAT_INCLUDE_DIRS}
        /usr/include /usr/local/include
        /opt/local/include /sw/include
    PATH_SUFFIXES libav ffmpeg
)
find_path(LIBSWRESAMPLE_INCLUDE_DIR
    ...
    PATHS ${_LIBAV_SWRESAMPLE_INCLUDE_DIRS}
        /usr/include /usr/local/include
        /opt/local/include /sw/include
    PATH_SUFFIXES libav ffmpeg
)
find_path(LIBAVUTIL_INCLUDE_DIR
    ...
    PATHS ${_LIBAV_AVUTIL_INCLUDE_DIRS}
        /usr/include /usr/local/include
        /opt/local/include /sw/include
    PATH_SUFFIXES libav ffmpeg
)
...
find_library(LIBAVDEVICE_LIBRARY
    NAMES avdevice
    PATHS ${_LIBAV_AVDEVICE_LIBRARY_DIRS}     #pkg-config
          /usr/lib /usr/local/lib           #system level
          /opt/local/lib /sw/lib            #macports & fink
)
...
find_library(LIBAVFILTER_LIBRARY
    NAMES avfilter
    PATHS ${_LIBAV_AVFILTER_LIBRARY_DIRS}     #pkg-config
          /usr/lib /usr/local/lib           #system level
          /opt/local/lib /sw/lib            #macports & fink
)
find_library(LIBSWRESAMPLE_LIBRARY
    NAMES swresample
    PATHS ${_LIBAV_SWRESAMPLE_LIBRARY_DIRS}     #pkg-config
          /usr/lib /usr/local/lib           #system level
          /opt/local/lib /sw/lib            #macports & fink
)
